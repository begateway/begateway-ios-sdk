 ...
 */
@objc protocol MaskedTextFieldDelegateListener: UITextFieldDelegate {
...
class MaskedTextFieldDelegate: NSObject, UITextFieldDelegate {
    ...
    @discardableResult
    func put(text: String, into field: UITextField, autocomplete putAutocomplete: Bool? = nil) -> Mask.Result {
    ...
    func deleteText(inRange range: NSRange, inTextField field: UITextField) -> Mask.Result {
    ...
    func modifyText(inRange range: NSRange, inTextField field: UITextField, withText text: String) -> Mask.Result {
    ...
    func notifyOnMaskedTextChangedListeners(forTextField textField: UITextField, result: Mask.Result) {
