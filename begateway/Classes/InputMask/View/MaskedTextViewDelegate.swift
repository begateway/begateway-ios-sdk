 ...
 */
@objc protocol MaskedTextViewDelegateListener: UITextViewDelegate {
 ...
 */
@IBDesignable
class MaskedTextViewDelegate: NSObject, UITextViewDelegate {
    
    weak var listener: MaskedTextViewDelegateListener?
    var onMaskedTextChangedCallback: ((_ textField: UITextView, _ value: String, _ complete: Bool) -> ())?
    ...
    /**
     ...
     Default is ```true```.
     */
    @IBInspectable var atomicCursorMovement: Bool = true
    ...
    @discardableResult
    func put(text: String, into textView: UITextView, autocomplete putAutocomplete: Bool? = nil) -> Mask.Result {
    ...
    func deleteText(inRange range: NSRange, inTextView textView: UITextView) -> Mask.Result {
    ...
    func modifyText(inRange range: NSRange, inTextView textView: UITextView, withText text: String) -> Mask.Result {
    ...
    func notifyOnMaskedTextChangedListeners(forTextView textView: UITextView, result: Mask.Result) {
