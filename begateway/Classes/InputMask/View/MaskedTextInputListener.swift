...
@available(iOS 11, *)
protocol OnMaskedTextChangedListener: AnyObject {
...
@available(iOS 11, *)
@IBDesignable
class MaskedTextInputListener: NSObject {

    weak var listener: OnMaskedTextChangedListener?
    var onMaskedTextChangedCallback: ((_ textInput: UITextInput, _ value: String, _ complete: Bool) -> ())?

    @IBInspectable var primaryMaskFormat:   String
    @IBInspectable var autocomplete:        Bool
    @IBInspectable var autocompleteOnFocus: Bool
    @IBInspectable var rightToLeft:         Bool
    ...
    @discardableResult
    func put(text: String, into field: UITextInput, autocomplete putAutocomplete: Bool? = nil) -> Mask.Result {
    ...
    func isDeletion(inRange range: NSRange, string: String, field: UITextInput) -> Bool {
    ...
    func deleteText(inRange range: NSRange, inTextInput field: UITextInput) -> Mask.Result {
    ...
    func modifyText(inRange range: NSRange, inTextInput field: UITextInput, withText text: String) -> Mask.Result {
    ...
    func pickMask(forText text: CaretString, autocomplete: Bool) -> Mask {
    ...
    func notifyOnMaskedTextChangedListeners(forTextInput textInput: UITextInput, result: Mask.Result) {
